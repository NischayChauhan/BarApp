...
//            Log.e( "onCreate: ","HIIHIHI" );
        ...
        if (savedInstanceState == null) {
            ...
            ((ImageView) findViewById(R.id.detail_image)).setImageResource(R.mipmap.ic_launcher);
            DummyContent.DummyItem mItem = DummyContent.ITEM_MAP.get(getIntent().getStringExtra(DrinkDetailFragment.ARG_ITEM_ID));
            if(!mItem.drink_image.isEmpty()){
                Picasso.get()
                        .load(mItem.drink_image)
                        .fit()
